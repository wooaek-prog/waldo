...
| --- | --- | --- |
| 구성 | 1개동 70층 1.5:1 (28.38×18.92m) | 1개동 50층 1.75:1 (36.27×20.72m) |
| 교사동 기준A | **81.3%** (기존 78.6% 대비 +2.7%p) | **80.0%** (+1.3%p) |
| 채광 이격 | 50.6m / 52.6m 필요 → 2.0m 부족 | 38.4m / 37.9m 필요 → 충족 |

이격을 지키면 타워가 대지 중앙으로 밀려 **학교 일조가 오히려 1.3%p 나빠지는**
역설이 있습니다(이격 규정은 인접 대지 보호 조항이지 학교 일조 보호 조항이
아니기 때문). [docs/hwarang_redesign_report.md](docs/hwarang_redesign_report.md) 참조.
