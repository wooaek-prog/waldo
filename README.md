...
수평 배치는 **교육환경평가 분석지점도와 같은 방식**입니다 — 교실 모듈 9.0m에
교실당 창 2개소(교실 중심 ±1.8m), 계단실·출입구·필로티 제외. 여의도여고 본관동
분석지점도를 이 규칙으로 재현하면 층별 점 수가 **도면과 정확히 일치**합니다
(5층 10 / 4층 16 / 3층 16 / 2층 14 / 1층 10, 합계 66점).
